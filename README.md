...
<!--<blockquote>-- ##### - smaller ... -->
**20.4.2026:** Another match covered in volume "Reflections on Everything" (Listove) from _The Prophets_ in 2025 and published also as a paper: **Wolpert’s Theorems about Mutual Unpredictability and the Impossibility of Subuniverses to Predict with Highest Resolution of Causality-Control are Rediscoveries of Concepts from Theory of Universe and Mind – Entangled with Unnecessary Mathematical Notation and Unsatisfiable Premises** https://artificial-mind.blogspot.com/2026/04/wolperts-theorem-about-mutual-unpredictability-rediscovers-theory-of-universe-and-mind.html
* See other matches with the school of Relevance Realization in _The Prophets_ - main volume and Listove [add details]
* See other significant correspondances and rediscoveries in the AGI conference 2024 paper by Thorisson & Talevi, 2024 to the **20+ years earlier** TUM & "Analysis of the meaning of a sentence (..) ", 2004 [add the links and details - wrap Analysis ... as a paper in ResearchGate & Academia]
* A Theory of Foundational Meaning Generation in Autonomous Systems, Natural and Artificial Thórisson, K.R. & Talevi, G. (2024)

**Note 29.8.2025, +8.10.2025** **Latest discovery: Michael Bennett also rediscovers motives from TUM**, e.g. a claim that there's no sharp border between software and hardware, hardware is the lower level from the POV of the current; the pancomputationalistm (which is more and more common already) and that everything serves as memory and for computation, "time is change" (see e.g. Universe and Mind 3 in 2003, point 11; also UnM-4, p. 12-13 (...)"; etc. There are differences in interpretations and for example in "the love" of formulas and theorems defined as mathematical ones, expressed with caligraphic fonts etc. which TUM lacked and didn't find necessary for the definitions. I discovered these works today 29.8.2025 via a video from MLST and read quickly his papers, more detailed comparison later and in _The Prophets_. Read more in the book from The Prophets now published: Stack Theory is yet another Fork of Theory of Universe and Mind: https://twenkid.com/agi/Stack-Theory-is-Fork-of-Theory-of-Universe-and-Mind-13-9-2025.pdf That monograph includes reviews of quotes from the visionary texts from 2001 and 2003 with LLMs also estimating being up to decades ahead of the mainstream AI research.
While studying Bennet's work I discovered also a theory of meaning by Thorisson and Talevi from 2024, published at the AGI conference, which is a rediscovery of TUM and a lot of the content of "Analysis of the meaning of a sentence ....", 3.2024. Links to chats with LLMs comparing them were included in the aforementioned book.
* Regarding memory, I found that Levin's "Self-improvizing memory ...", 2024 has rediscoveries of my proposals and conclusions published 20+ years earlier; that's addressed as an article in another appendix-volume on "Science Fiction. Futurology. Cybernetics. Human Development":
https://twenkid.com/agi/SF_Futurology_Cyber_Transhumanism_The_Prophets_of_the_Thinking-Machines_3-10-2025.pdf - search "Interpretations of Michael Levin’s Self-Improvising Memory: A Perspective on Memories as Agential, Dynamically Reinterpreting Cognitive Glue and Comparison to Theory of Universe and Mind 2001-2004+", p.50 in current edition (exact page may change after updates).
#### * "Universe and Mind 6", announced in 2023, was also published already: https://twenkid.com/agi/Universe-and-Mind-6_22-9-2025.pdf
* Many ideas related and extending it, are spilled in many contextual responds, interpretations and extensions to papers and talks of other researchers and philosophers, in the second major volume of The Prophets: "**Listove**" (>520 p./ 8.10.2025, not published yet), in "**Irina**" and in the biggest principal volume (or "main volume", основен том, >1865 pages/8.10.2025); in most concentrated form in the first several hundreds of pages and in the review of many schools and researchers with theories and works similar or rediscovering TOUM, which continues in the numerous appendices.
https://twenkid.com/agi/Irina_The_Prophets_of_the_Thinking_Machines_26-9-2025.pdf
* Find a list of already published appendices and short descriptions of their content in the published ones.
...
#### This particular github page was not updated, it could be split etc, but I've been too busy to explore and work on other things. I wrote Universe and Mind 6 in mid 2023, but as I wanted to complete other things and parts, it's still not finished and published. In the mean time in 2024 I wrote a related small monograph called "Is Mortal Computation Required for Creation of Universal Thinking Machines?", answering Ororbia and Friston's paper. This one which was published at SIGI-2025 (but for now it is in Bulgarian, you may try machine translation). In brief - not just "motral computation" is not required for thinking machines, but according to my interpretation and analysis these notions are ill-defined, as is one of their motive "efficiency" - as TOUM also stated even in 2001, it is questionable whether cells are more complex than machines, and in this paper I argue that "efficiency" is often confused and is based on selective or falsified accounting. Etc. 
