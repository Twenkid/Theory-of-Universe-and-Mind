...
These works were not published in an academic environment - I was a teenager: a school boy and in the end of that period: a freshman in "Computer Science" at The University of Plovdiv and I practically had neither peers, nor leaders, nor supervisors (which were largely lacking in most of the time for my more ordinary R&D and creative activities at the time, such as software development, linguistics and sociolinguistics, creative and analytical writing etc. - some of the works from the theory were presented in the form of fiction: "The Truth" (Истината) and "Ada". 

I've been somewhat in the academia and an affiliated researcher as a student in Plovdiv and in Wolverhamption (e.g. where I created the "most intelligent dictionary" <a href="https://github.com/Twenkid/Smarty">Smarty</a> back in 2007) or when I taught the AGI courses), but currently I am not affiliated, besides in my own virtual interdisciplinary research institute "The Sacred Computer", created in the year 2000 as an e-zine; it has several other attached aliases and chapters such as "Society Mind" (or "Reason" - Дружество Разум, a chapter in the e-zine), "Artificial Mind" (in Bulgarian it is also Reason - "Изкуствен разум" - a blog since 2007), "Twenkid Research". A page with short "normal" bio: http://research.twenkid.com/
