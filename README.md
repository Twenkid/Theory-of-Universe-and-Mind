...
* "All intelligence is a collective intelligence" - as Levin and others now discuss today. That was discussed starting from "Man and Thinking Machine",2001: that current human intelligence is a result of the work of the whole Universe, and in a view segmenting the world as man/machines, each of us is a result of the work of all previous generations of humans and technology. Also regarding the points about "consciousness prior".
* Juergen Schmidhuber is probably earlier in some of the AI-related stuff, or about similar times regarding some architectural aspects regarding AGI, such as the hierarchical predictors/simulators framework (here some may say that it's just a "rehash of optimal control theory"). His ideas about art are prior and expressed more technically, but in TOUM I discovered myself similar or related explanations about beauty/creativity (also "originality" in my terms, who is more original and why) without knowing his work (I discovered him in late 2009)
