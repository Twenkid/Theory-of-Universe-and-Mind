# Theory of Universe and Mind or "The Bulgarian Prophecies" in Artificial General Intelligence (AGI), Digital Universe/The Universe Computer, Philosophy of AI and Mind, A unification of Universe, Mind, Computation, Evolution, AI etc. 2001-2004 etc.

Todor Arnaudov's "Theory of Universe and Mind", originally created in 2001-2004, a general "theory of everything", unifying Cybernetical Digital Physics Cosmology and Evolution of the Universe with (Artificial) General Intelligence and Philosophy of Mind and mapping to human behavior, motivation, reinforcement learning, society (...). It is yet a little known predecessor of many other analogical, related and similar theories, which are recently getting more elaborated and scientific, supported with technical papers and promoted by world renowned researchers. I discovered Karl Friston's "Free energy principle" theory in late 2018 and Michael Levin's work as late as late February? 2023 and their ideas are still cutting edge in 2023.

Due to the predictions and the large number of matches of future works to the claims, ideas, hypotheses and the reasoning to the works from "Theory of Universe and Mind" (ToUM) and some related works, I recently called them also "The Bulgarian Prophecies" or "The Bulgarian Predictions" in AGI, Philosophy of AI and Mind, Digital physics etc., together with a strategical essay/proposal from 2003 for the development of AGI via the creation of a super interdisciplinary R&D institute. The "prophecies" are Bulgarian for several reasons: because of my nationality, because they were originally written in Bulgarian and the theory was taught during the world's first, radically interdisciplinary, course in Artificial General Intelligence in 2010 and 2011 at the University of Plovdiv, Bulgaria with working language Bulgarian - note the MIT's AGI course led by Lex Fridman was in 2018, I claim that my course and my syllabum was way better, because it had a strong structure, theory and a message and what it proposed and explained seems to be confirmed and approved by the future. See the syllabum in the link or the appendix.

A "bibleically" sized documentary book, demonstrating, justifying, proving the "prophecies" is in an "ever-continuing" "final preparation": *"The prophets of the Thinking Machines: Artificial General Intelligence and Transhumanism: History Theory and Pioneers"*. It is currently in Bulgarian, about 1350 pages ready, a lot of documentary/comparison material to include which may extend it to 14xx or 1500+ depending on the selection. It had a complete version as early as 2020 when I started, but then it was about 800-something pages.
...
* As there was nobody to properly review or perhaps understand these works back then, I consider all these later coming matches as a sort of delayed indirect reviews and confirmations, done independently by all these top researchers, which I view as a proof of my correct direction; research, capability for doing the right generalization from little or no empirical data and general thinking capability, reasoning, claims, conclusions, hypotheses, logic, way of thinking, models, predictions etc.

However as these works were not published in an academic environment - I was a teenager: a school boy and at the end of that period: a freshman in "Computer Science" at The University of Plovdiv and I practically had neither peers, nor leaders, nor supervisors (which were largely lacking in my more ordinary R&D and creative activities in my teenage years such as software development, linguistics and sociolinguistics, creative and analytical writing etc.), - and while I've been somewhat in the Academia for a short time (e.g. when creating the "most intelligent dictionary" back in 2007 or when I taught the AGI courses),  I am not existing in a proper "normal" hierarchy of affiliations in the funded and established system. I am the creator and the sole Jack of All Trades in my virtual interdisciplinary research institute "The Sacred Computer", which could be defined as created in the year 2000 as the e-zine with that title, and it has several other attached virtual names and chapters such as "Society Mind" (or "Reason" - Дружество Разум, a chapter in the e-zine), "Artificial Mind" (in Bulgarian it is also Reason - "Изкуствен разум" - a blog since 2007), "Twenkid Research".
...
* "All intelligence is a collective intelligence" - as Levin and others now discuss today. That was discussed starting from "Man and Thinking Machine",2001: that current human intelligence is a result of the work of the whole Universe, and in man/machines segmentation, the end result of the work of all previous generations of humans and technology. A single man, starting from scratch in the wild without any human technology would not achieve much more than an ape.
