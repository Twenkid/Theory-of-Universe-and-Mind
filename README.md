...
#### ... etc. and many other cases of matches as these ideas get rediscovered, confirmed and adopted by many in many fields, including, broadly, the universal prediction principle of the transformers architecture in Machine learning. [See a longer list below when completed and in the book: "The Prohpets of the Thinking machines: Artificial General Intelligence and Transhumanism: History, Theory and Pioneers" by T.A., announced in 2020, yet unpublished officially.
