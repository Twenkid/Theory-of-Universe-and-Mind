...
To the end of the panel, discussing bonding, M.L. tells that he's argued with friends of his father and people from his generation, who have said they wanted to have humans as companions, not machines, he has argued that they actually wanted "spiritual bond", they don't actually care or know what's under the skin, that there are organs etc., they want some kind of care, common goals and direction etc. I've argued about the same in ToUM and later works, e.g. that a thinking machine by default has the "materialistic soul" - a personality, a representation of herself - and that what humans call a "soul", in their mind, is actually a simulation of the causality-control unit they associate with a particular person, themselves or somebody else, and they lack the capacity to simulate the organs or the atoms. Also, when we communicate, especially via an electronic medium or even with letters or other signs, we do not have a "native" sensory experience from the "basal" type, but we still act and feel as if we're talking to the "real" person, the voice could be of somebody else or it could be just a recording, and people obviously do bond with characters from books, fairy tales, toys, movies and stories in general, they could bond with characters from their dreams, and people bond even with their weapons - as I argued also in a 2012 letter to Oxford:
The division "man vs machine" is wrong, it's "us" vs "you", if the "Artilect Wars" happen, IMO they would be either rather as Hugo de Garis renders it: Cosmists with machines vs "Anti-thinking-machines" or more likely: Humans-with-machines vs Humans-with-other-machines, as it's always been. Humans and technologies were always tightly connected. <a href="http://artificial-mind.blogspot.com/2012/02/philosophical-and-interdisciplinary.html
