...
### TOUM is years and decades earlier predecessor of a family of analogical, related or similar works and theories, in some or in most of their aspects; such as: Karl Friston's Free Energy Principle/Active Inference, Michael Levin's set of concepts in Technnological-Approach-To-Mind-Everywhere-(TAME)--Cognitive-Light Cone--Scale-Free Cogntion/Computational Boundary of a Self; many of Joscha Bach's views; Bobby Azarian's 2022 book; the principles of consciousness of Ogi Ogas and Sai Gaddam's from "Journey of the Mind: How Thinking Emerged from Chaos"*, 2022; Yosha Bengio's 2017-2018 "Consciousness Prior"; Jeff Hawkins' principles from the book "On Intelligence",2004, "Memory-Prediction Framework" 
#### ... etc. and many other cases of matches as these ideas get rediscovered, confirmed and adopted all around
