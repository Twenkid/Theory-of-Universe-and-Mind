...
Todor Arnaudov's "Theory of Universe and Mind" (Also "Theory of Mind and Universe", or "Вселена и Разум", "Теория на Разума и Вселената";  an English translation file for the AGI course titled also "Theory of Hierarchical Universal Simulators of Universes"), originally created in 2001-2004 is a general "theory of everything", unifying Cybernetical Digital Physics Cosmology and Evolution of the Universe with (Artificial) General Intelligence and Philosophy of Mind and mapping to human consciousness (subjective experience), behavior and decision making, motivation, reinforcement learning, society (...). 

This theory is yet a little known predecessor of many other analogical, related and similar works and theories, which are recently getting more elaborated, technical and scientifically and empirically grounded and promoted by world renowned researchers. I discovered Karl Friston's "Free energy principle" theory in late 2018 from an interview for Wired and Michael Levin's work as late as late February? 2023, some of his papers such as TAME and Scale-free Cognition are very recent and their ideas are still cutting edge in 2023.

Due to the predictions and the large number of matches of future works to the claims, ideas, hypotheses and the reasoning to the works from "Theory of Universe and Mind" (ToUM) and some related works, I recently called them also "The Bulgarian Prophecies" or "The Bulgarian Predictions" in AGI, Philosophy of AI and Mind, Digital physics etc., together with a strategical essay/proposal from 2003 for the development of AGI via the creation of a super interdisciplinary R&D institute and other publications. The "prophecies" are Bulgarian for several reasons: because of my nationality, because they were originally written in Bulgarian and the theory was taught during the world's first, radically interdisciplinary university course in Artificial General Intelligence in 2010 and 2011 at the University of Plovdiv, Bulgaria with working language Bulgarian. Note the MIT's AGI course led by Lex Fridman was in 2018, I claim that my course and my syllabum was way better, because it had a strong structure, theory and a message and what it proposed and explained seems to be confirmed and approved by the future. See the syllabum and a video: http://artificial-mind.blogspot.com/2010/04/universal-artificial-intelligence.html
