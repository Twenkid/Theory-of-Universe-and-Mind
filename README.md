...
* Stephen Wolfram's computationalist views and Digital Physics, truth as construction and not binary logic, intelligence being in a continuous space with computation etc., see e.g., "Computational evolution and human progress", 8.5.2023: https://youtu.be/gRK1cdeRUv0  @10 min, @15 min etc. with Lex Fridman at MIT, see also "Vectors of Cognitive AI" with Joscha Bach
